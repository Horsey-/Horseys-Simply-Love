...
t[#t+1] = Def.Sprite{
	Name="GroupBanner",
	OnCommand=function(self) self:setsize(bannerWidth, bannerHeight):visible(false):playcommand("Set") end,
	CurrentSongChangedMessageCommand=function(self) self:playcommand("Set") end,
	CurrentCourseChangedMessageCommand=function(self) self:playcommand("Set") end,
	SetCommand=function(self)
		SongOrCourse = GAMESTATE:IsCourseMode() and GAMESTATE:GetCurrentCourse() or GAMESTATE:GetCurrentSong();
...
if PREFSMAN:GetPreference("ShowBanners") then
	t[#t+1] = Def.ActorProxy{
		Name="BannerProxy",
		OnCommand=function(self) self:setsize(bannerWidth, bannerHeight) end,
